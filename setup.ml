...
(* OASIS_START *)
(* DO NOT EDIT (digest: 099d620324f28f6c7d2548aa356ac98d) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          authors = ["Kellen Fox"];
          homepage = None;
          synopsis = "merkel tree hash calculator";
          description = None;
          categories = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [FindlibPackage ("sha.sha256", None)];
                   ...
                   {exec_custom = false; exec_main_is = "merkel.ml"})
            ];
          plugins = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\001\250\144w\030\167a\151\161,.W\196\1874\020";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
